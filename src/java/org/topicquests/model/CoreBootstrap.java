...
public class CoreBootstrap extends BootstrapBase implements IBootstrap {
	...
	private IResult doBootstrap() {
		...
		//PROPERTIES
			...
			makeSubclassNode(ITopicQuestsOntology.PROPERTY_TYPE,ITopicQuestsOntology.VERSION_PROPERTY_TYPE,ICoreIcons.PROPERTY_ICON_SM,ICoreIcons.PROPERTY_ICON,"Version Property Type", "The TopicQuests typology version property type.", result);
